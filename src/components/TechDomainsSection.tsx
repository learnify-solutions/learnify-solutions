        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {domains.map((domain) => (
            <div
              ...
              className="group bg-white rounded-xl p-6 border border-slate-200 shadow-xs hover:shadow-md hover:border-slate-300 transition-all cursor-pointer flex flex-col justify-between space-y-4"
            >
              ...
              <div className="flex items-center justify-between">
                ...
                {domain.isTrending ? (
                  <span className="text-[10px] font-extrabold tracking-wider px-2 py-0.5 rounded-full bg-orange-100 text-[#ea6d24] uppercase">
                    TRENDING
                  </span>
                ) : (
